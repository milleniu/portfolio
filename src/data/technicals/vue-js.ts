...
export class VueJS extends BlogPostBase {
  ...
  content: ReadonlyArray<BlogPostContent> = [
    ...
    new List([
      "Il utilise le modèle MVVM ainsi qu'un système de réactivité pour la donnée qui exploite le " +
    ...
    new Paragraph(
      ...
      "les projets plus anciens du fait de sa malléabilité. Recommencer ces derniers à zéro n'est pas " +
      "envisageable, car le coût et le temps de développement nécessaire sont trop importants."
    ),
    new List([
      ...
      "le framework et de le mettre en cohabitation avec d'autres frameworks et ainsi de faire migrer le " +
      "site au fur et à mesure.",

      "Pour des applications plus légères qui ne nécessitent pas une architecture complexe et avancée, " +

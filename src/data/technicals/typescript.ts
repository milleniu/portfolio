...
export class Typescript extends BlogPostBase {
  ...
  public readonly content: ReadonlyArray<BlogPostContent> = [
    ...
    new List([
      ...
      "éxistant. De plus, il n'est pas obligatoire d'utiliser tout de suite l'ensemble des fonctionnalités, on " +
    ...
    new List([
      ...
      "Je dois également implémenter des alogrithmes Front End. Pour ce type de programme plus complexes, il " +
